...
class PublicData:
	...
	def check_spf_redirect_mechanisms(self, spf_record):
	...
	def check_spf_include_mechanisms(self, spf_record):
	...
	def is_spf_redirect_record_strong(self, spf_record):
	...
	def are_spf_include_mechanisms_strong(self, spf_record):
	...
	def check_spf_include_redirect(self, spf_record):
	...
	def check_spf_all_string(self, spf_record):
	...
	def is_spf_record_strong(self, domain):
